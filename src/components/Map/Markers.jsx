...
import SHList from '../../SHList.json'
import './markers.scss'
...
const Markers = () => (
    SHList.map(item => {
        const coordinates = item.geo;
        return (
            <Marker coordinates={coordinates} key={item.id}>
                <div className='marker' style={{ width: "5px", height: "5px", position: "relative" }} >
                    <svg
                        style={{position: "absolute", height: "5em", width: "5em"}}
                    ...
                    >
                        <defs>
                            <linearGradient >
                                <stop offset="0" stopColor="#00f96e" stopOpacity="0.412"></stop>
                            </linearGradient>
                            <linearGradient >
                                <stop offset="0" stopColor="#0d8052" stopOpacity="1"></stop>
                            </linearGradient>
                            <linearGradient >
                                <stop offset="0" stopColor="#a6a6a6" stopOpacity="1"></stop>
                            </linearGradient>
                            <filter
                                id="a"
                                width="1.313"
                            ...
                            >
                                <feGaussianBlur stdDeviation="2.44"></feGaussianBlur>
                            </filter>
                        </defs>
                        <g
                            fillOpacity="1"
                        ...
                        >
                            <path 
                                className="not-ellipse"
                                fill="#fff"
                                strokeOpacity="0.67"
                                strokeWidth="4.291"
                                d="M63.811 246.289c3.345 11.845-11.176 22.276-24.964 22.276-13.787 0-31.09-11.585-24.964-22.276 6.24-10.893 17.262-24.022 24.964-22.276 14.737 3.34 22.128 12.229 24.964 22.276z"
                                opacity="1"
                            ></path>
                            <path
                                className="not-ellipse"
